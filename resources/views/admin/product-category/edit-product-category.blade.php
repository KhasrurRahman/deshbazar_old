        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="text-success text-center">Edit Product Category Form</h4>
                </div>
                <div class="panel-body">
                    {{Form::open(['route'=>'update-product-category','method'=>'POST','class'=>'form-horizontal','enctype'=>'multipart/form-data'])}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <br />
                            <img src="{{asset($category->category_image)}}" alt="" width="40" height="40"/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-md-8 col-md-offset-4">
                            <input type="submit" name="btn" class="btn btn-success btn-block" value="Update Product Category" />
                        </div>
                    </div>
                    {{Form::close()}}
                </div>
