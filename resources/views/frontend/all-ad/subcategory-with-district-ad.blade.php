            ...
            <div class="row">
                                            ...
                                            <ul>
                                                ...
                                                <li class="media">
                                                    ...
                                                    'districtId'=>$district->id,
                                                        ...
                                                        <div class="media-body">{{$district->district_name}}</div>
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                ...
                <div id="custo_add">
                    ...
                    <div class="col-md-7 well">
                        ...
                        <p><a href="{{route('/')}}">হোমপেজ</a> -> <a href="{{route('all-ad')}}">সকল বিজ্ঞাপন</a> -> <a href="{{route('divisional-product',['id'=>$div->id])}}"> {{$div->division_name}} </a> -> <a href="{{route('district-ad',['id'=>$district->id])}}"> {{$district->district_name}}</a> -> <a href="{{route('category-product',['id'=>$cat->id])}}"> {{$cat->category_name}} </a> -> <a href="{{route('subcategory-product',['id'=>$subCategory->id])}}"> {{$subCategory->subcategory_name}} </a> </p>
