                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <select onchange="document.location=this.value;">
                                    ...
                                    <option value="{{route('price-desc')}}" selected="selected">মূল্যঃ সর্বোচ্চ থেকে সর্বনিম্ন</option>
                                    <option value="{{route('price-asc')}}">মূল্যঃ সর্বনিম্ন থেকে সর্বোচ্চ</option>
                                </select>
                            </div>
                        </div>
                    </div>
