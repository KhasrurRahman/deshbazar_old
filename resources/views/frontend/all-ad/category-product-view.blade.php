            ...
            <div class="row">
                                                    ...
                                                    <li class="media">
                                                        ...
                                                        'divisionId'=>$division->id,
                                                            ...
                                                            <div class="media-body">{{$division->division_name}}
                                                                @if( isset($division->category1_products_count))
                                                                    <span style="color:darkslategray;">({{$division->category1_products_count}})</span>
                                                                @elseif(isset($division->category2_products_count))
                                                                    <span style="color:darkslategray;">({{$division->category2_products_count}})</span>
                                                                @elseif(isset($division->category3_products_count))
                                                                    <span style="color:darkslategray;">({{$division->category3_products_count}})</span>
                                                                @elseif(isset($division->category4_products_count))
                                                                    <span style="color:darkslategray;">({{$division->category4_products_count}})</span>
                                                                @elseif(isset($division->category5_products_count))
                                                                    <span style="color:darkslategray;">({{$division->category5_products_count}})</span>
                                                                @elseif(isset($division->category6_products_count))
                                                                    <span style="color:darkslategray;">({{$division->category6_products_count}})</span>
                                                                @elseif(isset($division->category7_products_count))
                                                                    <span style="color:darkslategray;">({{$division->category7_products_count}})</span>
                                                                @elseif(isset($division->category8_products_count))
                                                                    <span style="color:darkslategray;">({{$division->category8_products_count}})</span>
                                                                @elseif(isset($division->category9_products_count))
                                                                    <span style="color:darkslategray;">({{$division->category9_products_count}})</span>
                                                                @elseif(isset($division->category10_products_count))
                                                                    <span style="color:darkslategray;">({{$division->category10_products_count}})</span>
                                                                @elseif(isset($division->category11_products_count))
                                                                    <span style="color:darkslategray;">({{$division->category11_products_count}})</span>
                                                                @elseif(isset($division->category12_products_count))
                                                                    <span style="color:darkslategray;">({{$division->category12_products_count}})</span>
                                                                @elseif(isset($division->category13_products_count))
                                                                    <span style="color:darkslategray;">({{$division->category13_products_count}})</span>
                                                                @elseif(isset($division->category14_products_count))
                                                                    <span style="color:darkslategray;">({{$division->category14_products_count}})</span>
                                                                @elseif(isset($division->category19_products_count))
                                                                    <span style="color:darkslategray;">({{$division->category19_products_count}})</span>
                ...
                <div id="custo_add">
                    ...
                    <div class="col-md-7 well">
                        ...
                        <p><a href="{{route('/')}}">হোমপেজ</a> -> <a href="{{route('all-ad')}}">সকল বিজ্ঞাপন</a> -> <a href="{{route('category-product',['id'=>$cat->id])}}"> {{$cat->category_name}} </a></p>
